...
class ComposeFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivPreview = view.findViewById(R.id.iv_picture)
    ...
    private fun submitPost(description: String, user: ParseUser, file: File) {
        ...
        post.saveInBackground { exception ->
            if (exception != null) {
                ...
                Toast.makeText(requireContext(), "Error occurred while saving post", Toast.LENGTH_SHORT).show()
            } else {
...
//        Log.i(MainActivity.TAG, "Current user: ${currentUser}")
